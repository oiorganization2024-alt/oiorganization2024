...
def admin_panel():
    ...
    # খরচ ব্যবস্থাপনা — ৬টি ফাংশন সহ
        ...
        # ফাংশন ২, ৩, ৪, ৫, ৬: তালিকা, মোট, ডিলিট, অটো রিফ্রেশ, খালি অবস্থা
        with tab2:
            ...
            if not expenses:
                ...
                # ফাংশন ৪ ও ৫: ডিলিট বাটন — কনফার্মেশন ছাড়া, অটো রিফ্রেশ
                for exp in expenses:
                    ...
                    with col2:
                        # ফাংশন ৪: ডিলিট — কোনো কনফার্মেশন নেই, ব্যালেন্স অপরিবর্তিত
